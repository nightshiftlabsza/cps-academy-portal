...
const allowed=new Set(['index.html','session-core.js','search-core.js','identity.js','offline.js','logbook.js','windowed-list.js','members.js','morning-report.js','app.js','styles.css','members.css','morning-report.css','workbook.json','sw.js']);
